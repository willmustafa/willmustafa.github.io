export default {
  home: {
    ...
    headline:
      "Sou engenheiro de software em busca de automatizar o seu dia a dia.",
    working:
      "Trabalho atualmente como <b>Desenvolvedor Full Stack na <a href='https://integra.do/' target='_blank'>Integra.do</a></b>",
  },
  nav: {
    home: "Home",
    portfolio: "Portfolio",
